---
title: "Variance-partitioning model"
...
Omega_I = L * L';
cov_int_phi = Omega_I[1,2]*sqrt(Sigma2_phi*Sigma2_intercept);
...
stan_func<-function(datalist){
  ...
  md <- stan("RR.stan", data = datalist,
               pars = c("B_0", "Sigma2_intercept", "Sigma2_phi", "cov_int_phi", "Sigma2_e"),
...
output$Parameter <- rep(c("B_0", "Sigma2_intercept", "Sigma2_phi", "cov_int_phi", "Sigma2_e", "lp_"),length(datalist))
