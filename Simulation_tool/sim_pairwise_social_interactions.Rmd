...
Vepsilon = 0.1    # variance social partner effect (residual impact)
...
r_alpha_epsilon  =  0.4     # part of Cov int-phi
r_alpha_psi      =  0       # part of Cov int-psi 
r_epsilon_psi    =  0       # part of Cov psi-phi 
r_alpha_x        =  0.4     # part of Cov int-phi 
r_psi_x          =  0       # part of Cov psi-phi 
r_epsilon_x      =  0
```
