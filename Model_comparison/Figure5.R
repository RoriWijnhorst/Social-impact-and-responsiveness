...
df2_800_100_8_1x  <-read.csv("res_800_100_8_1x_M2.csv")
df2_800_50_16_1x  <-read.csv("res_800_50_16_1x_M2.csv")

df3_800_400_2_1x  <-read.csv("res_800_400_2_1x_M3.csv")
df3_800_200_4_1x  <-read.csv("res_800_200_4_1x_M3.csv")
...
p2<-ggplot(summary2,(aes(x=ind, y=MAE*100, col=Parameter, group=Model))) +
  ...
  scale_colour_manual(values=c("#8DA0CB"), labels=c("\U1D449\U1D719"),
                      guide="none") +
  scale_shape_discrete(labels=c("novel I&R", "V-P", "Hybrid"))+
  scale_linetype_discrete(labels=c("novel I&R", "V-P", "Hybrid"))+
  theme_bw(base_size=10) +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
...
plot1<-ggplot(df1,aes(x = ind, y = V3, fill=Model,col= Parameter, group=interaction(Model,ind,Parameter))) + 
  ...
  scale_colour_manual(values="#E5C494", labels=c("\U1D713"),
                      guide="none") +
  scale_fill_manual(values= c("#F0F0F0","#636363"), guide="none") +
  theme_bw(base_size = 10) +
  theme(
...
plot3<-ggplot(df3,aes(x = ind, y = V3, col= Parameter,fill=Model, group=interaction(Model,ind,Parameter))) + 
  ...
  scale_colour_manual(values=c("#E78AC3"), labels=
                      ...
                      guide="none") +
  scale_fill_brewer(palette = "Greys", labels=c("novel I&R","V-P", "Hybrid")) +
  theme_bw(base_size = 10)+
  theme(
    panel.grid.major = element_blank(),
    panel.grid.minor = element_blank(),
